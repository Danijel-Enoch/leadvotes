  ...
  return (
    <main className='flex justify-center mt-[120px] '>
      <section className='font-medium'>
        <h1 className='font-semibold text-[40px] leading-[60px] mb-[30px]  '>Create poll</h1>
        <div>
          <div className='bg-[#4F4F4F] text-[30px] font-medium leading-[45px] rounded-t-[12px] flex justify-evenly '>

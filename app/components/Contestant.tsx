...
const Contestant = () => {
  return (
    ...
    <section className='pt-[30px] lg:pt-[60px] bg-[#151515] rounded-b-[12px] w-full '>
      <form className='w-fit mx-auto  lg:mb-[60px] lg:ml-[45px]   text-[12px] lg:text-[25px] font-medium leading-[37.5px] w-[90%] lg:w-full mx-auto lg:mx-[0px] '>
        ...
        <Link href='/votes'>
        <button className='font-semibold text-white bg-[#1B5CFE] lg:w-[723px] w-full h-[50px] lg:h-[76px] rounded-[10px] hover:bg-[#1948b5] ' data-aos="zoom-in">Create Poll</button></Link>
        </div>
      </form>

  ...
  return (
    <main>
        ...
        <section className='text-center mt-[97px] '>
          ...
          <button className='rounded-[40px] bg-white hover:bg-[#1B5CFE] hover:text-white w-[172px] h-[57px] text-[#202020] text-[18px] font-bold leading-[27px]  '>Create poll</button>
        </section>
        <About />
        <Voting />
        <CreatePool />

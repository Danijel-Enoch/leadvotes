  ...
  return (
    <main>
        ...
        <section className='text-center mt-[51px] lg:mt-[97px] overflow-hidden'>
          ...
          <button className='rounded-[40px] bg-white hover:bg-[#1B5CFE] hover:text-white w-[172px] h-[57px] text-[#202020] text-[18px] font-bold leading-[27px] mt-[20px] lg:mt-[0px] '  data-aos="fade-up">Create poll</button>
        </section>
        <About />
        <Voting />
        <CreatePool />

    ...
    <main>
        ...
        <section className='flex justify-center  '>
            <div className='w-[80%] mt-[25px] '>
                <Image src={votetree} alt='tree-img' className='' />
                {votes.map((vote, index) => (
                <div  className='font-semibold text-center' key={index}>
                    <h1  className='text-[55px] leading-[82.5px] mt-[60px]'>Most Influential Student</h1>
                    ...
                    <div className='flex w-[535px] justify-evenly mx-auto mt-[30px] '>
                        <button className='w-[177px] h-[44px] rounded-[44px] border-[1px] border-[#636363] text-[20px] leading-[30px]'>1 vote</button>
                        <button className='w-[179px] h-[44px] rounded-[44px] border-[1px] border-[#636363] text-[20px] leading-[30px]'>2 contestants</button>
                        <button className='w-[159px] h-[44px] rounded-[44px] border-[1px] border-[#636363] text-[20px] leading-[30px] bg-[#1B5CFE5C] '>Edit Poll</button>
                    </div>
                </div>
                 )) }
                 <ContestantDetails />

					...
					{votes.map((vote, index) => (
						<div className="font-semibold text-center" key={index}>
							...
							<p className="lg:text-[19px] text-[16px] font-medium lg:leading-[28.5px] mb-[45px] mt-[20px] w-[80%] mx-auto  ">
								A beauty pageantry is a competition that has
								traditionally focused on judging and ranking the
								physical., A beauty pageantry is a competition
								that has traditionally focused on judging and
